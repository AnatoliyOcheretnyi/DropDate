...
### Go basics
- [x] Типи даних: `string`, `int`, `bool`, `time.Time`, `[]T`, `map[K]V`
- [x] Змінні/константи, пакетна структура, імпорти
- [x] Функції, повернення значень, множинне повернення
- [x] Умови, цикли, `switch`
