...
export default function DiscoverScreen() {
  ...
  return <SafeAreaView style={styles.safe}><AnimatedScreenContent><ScrollView contentContainerStyle={styles.content}>
