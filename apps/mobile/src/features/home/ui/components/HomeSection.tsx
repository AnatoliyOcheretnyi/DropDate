...
export function HomeSection({ title, kicker, variant = 'rail', items, isLoading, onPress, onAdd, onLongPress, isSaved, reasons }: Props) {
  ...
  return (
    <View style={styles.section}>
      ...
      {isLoading ? (
        ...
        <HomeRow items={items} onPress={onPress} onAdd={onAdd} onLongPress={onLongPress} isSaved={isSaved} />
      )}
    </View>
  );
}
