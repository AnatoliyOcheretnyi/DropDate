...
export function HomeMoodTeaser() {
  ...
  return (
    <LinearGradient
      colors={colors.isDark ? ['rgba(124,92,255,0.22)', 'rgba(84,255,182,0.12)'] : ['rgba(124,92,255,0.14)', 'rgba(0,182,115,0.1)']}
      start={{ x: 0, y: 0 }}
      end={{ x: 1, y: 1 }}
      style={styles.shell}
    >
      ...
      <Text style={styles.lead}>Обери настрій — і ми підберемо, що подивитись саме зараз.</Text>
...
const makeStyles = (colors: Palette) => StyleSheet.create({
  ...
  chip: {
    ...
    paddingVertical: 10,
    borderRadius: 999,
    backgroundColor: colors.isDark ? 'rgba(255,255,255,0.08)' : 'rgba(255,255,255,0.7)',
    borderWidth: 1,
    borderColor: colors.border,
  },
  emoji: {
