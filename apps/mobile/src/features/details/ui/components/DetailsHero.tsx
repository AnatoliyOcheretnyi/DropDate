...
type Props = {
  ...
  onAdd: () => void;
  isSaved: (suggestion: { id: number; title: string; mediaType: Details['mediaType'] }) => boolean;
};
      ...
      <View style={styles.hero}>
        ...
        <View style={styles.heroInfo}>
          <Text style={styles.eyebrow}>
            {details?.mediaType === 'movie' ? copy.details.facts.movie : copy.details.facts.series}
          </Text>
          <Text style={styles.title}>{details?.title}</Text>
          <Text style={styles.tagline}>{details?.tagline || ' '}</Text>
          <Text style={styles.overview}>{details?.overview || copy.hints.noOverview}</Text>
