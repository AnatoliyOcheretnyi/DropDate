...
export const featureStyles = StyleSheet.create({
  card: { backgroundColor: legacyColors.card, borderColor: legacyColors.border, borderWidth: 1, borderRadius: 20, padding: 18, gap: 12 },
  heading: { color: legacyColors.text, fontSize: 20, fontWeight: '800' },
  text: { color: legacyColors.textMuted, fontSize: 15, lineHeight: 21 },
  option: { padding: 15, borderRadius: 14, borderWidth: 1, borderColor: legacyColors.border, backgroundColor: legacyColors.card },
  optionSelected: { borderColor: legacyColors.accent, backgroundColor: 'rgba(84,255,182,0.12)' },
  optionText: { color: legacyColors.text, fontWeight: '700' },
  button: { padding: 15, borderRadius: 999, backgroundColor: legacyColors.accent, alignItems: 'center' },
